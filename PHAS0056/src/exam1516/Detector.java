...
public class Detector {
	...
	/**
	 * @return the mean of the amplitudes of the signals corresponding to this
	 *         detector
	 */
	...
	public String toString() {
		return "[detectorID= " + detectorID + ", Mean Amplitude: " + getMeanAmplitude() + "V, " + "Mean Arrival Time: "
				+ getMeanArrivalTime() + "ns, Particle Speed: " + getParticleSpeed() + "Gs]\n";
	}
