...
public class DetectorStore {
	...
	public DetectorStore(String urlName, SignalStore signalStore) throws Exception {
		...
		while (line != null) {
			...
			DetectorThreshold detectorThreshold = new DetectorThreshold(line);
			detectorThreshold.setSignalStore(signalStore);
			detectorThresholds.add(detectorThreshold);
