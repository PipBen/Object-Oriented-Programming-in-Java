...
public class Main1516 {
	...
	public static void main(String[] args) throws Exception {
		...
		DetectorStore detectors = new DetectorStore("http://www.hep.ucl.ac.uk/undergrad/3459/exam-data/2015-16/detectors.txt",signalStore, maxVoltageArrivalTime);
		...
		DetectorStore detectorThresholds = new DetectorStore("http://www.hep.ucl.ac.uk/undergrad/3459/exam-data/2015-16/detectors.txt",signalStore, thresholdArrivalTime);
