...
public class ExamPart2 {
	...
	public static void main(String[] args) throws Exception{
		...
		LengthTester lengthTester = new LengthTester(1);
		VolumeTester volumeTester= new VolumeTester(-20);
		System.out.println("recording01 classified as "+lengthTester.test(recording01)+", "+volumeTester.test(recording01));
		System.out.println("recording02 classified as "+lengthTester.test(recording02)+", "+volumeTester.test(recording02));
		System.out.println("recording03 classified as "+lengthTester.test(recording03)+", "+volumeTester.test(recording03));
		System.out.println("recording04 classified as "+lengthTester.test(recording04)+", "+volumeTester.test(recording04));
		System.out.println("genA classified as "+lengthTester.test(genA)+", "+volumeTester.test(genA));
		System.out.println("genB classified as "+lengthTester.test(genB)+", "+volumeTester.test(genB));
		System.out.println("genC classified as "+lengthTester.test(genC)+", "+volumeTester.test(genC));
